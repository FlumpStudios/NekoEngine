...
#define MAX_COMBO 5
#define COMBO_BAR_SIZE 175

#define SCORE_ENEMY_WORTH 100
#define SCORE_GEM_WORTH 50
...
#define WARRIOR_HEALTH 30
#define PLASMA_BOT_HEALTH 40
#define ENDER_BOT_HEALTH 255
#define TURRENT_BOT_HEALTH 10
#define EXPLODER_BOT_HEALTH 36

#define SPIDER_AGGRESION 40
#define DESTROYER_AGGRESION 90
#define WARRIOR_AGGRESION 255
#define PLASMA_BOT_AGGRESION 56
#define ENDER_BOT_AGGRESION 128
...
{
  /* spider  */ SFG_MONSTER_ATTRIBUTE(SFG_MONSTER_ATTACK_FIREBALL,SPIDER_AGGRESION,SPIDER_HEALTH,2),
  /* destr.  */ SFG_MONSTER_ATTRIBUTE(SFG_MONSTER_ATTACK_FIREBALL_BULLET,DESTROYER_AGGRESION,DESTROYER_HEALTH,3),
  /* warrior */ SFG_MONSTER_ATTRIBUTE(SFG_MONSTER_ATTACK_MELEE,WARRIOR_AGGRESION,WARRIOR_HEALTH,1),
  /* plasma  */ SFG_MONSTER_ATTRIBUTE(SFG_MONSTER_ATTACK_PLASMA,PLASMA_BOT_AGGRESION,PLASMA_BOT_HEALTH,1),
  /* ender   */ SFG_MONSTER_ATTRIBUTE(SFG_MONSTER_ATTACK_FIREBALL_PLASMA,ENDER_BOT_AGGRESION,ENDER_BOT_HEALTH,3),
  /* turret  */ SFG_MONSTER_ATTRIBUTE(SFG_MONSTER_ATTACK_BULLET,TURRENT_BOT_AGGRESION,TURRENT_BOT_HEALTH,0),
  /* explod. */ SFG_MONSTER_ATTRIBUTE(SFG_MONSTER_ATTACK_MELEE,EXPLODER_BOT_AGGRESION,EXPLODER_BOT_HEALTH,1)
};
...
{
  /* knife    */ SFG_WEAPON_ATTRIBUTE(SFG_WEAPON_FIRE_TYPE_MELEE,1,1250),    // DPS: 6.2
